  ...
  return (
    <Card className="p-4">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-lg font-medium dark:text-white">Business Details</h2>
        <button className="flex gap-1 items-center text-xs font-medium text-[#22C55E] dark:text-[#22C55E]">
          ...
          {['+1 344 434 4445', '+1 344 434 4445'].map((phone, index) => (
            <div key={index} className="flex mb-2 gap-2">
              <div className="flex-shrink-0">
                <select className="h-full p-2 text-sm bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-xl text-gray-900 dark:text-white">
                  <option>US</option>
                </select>
              </div>
              <input
                type="tel"
                value={phone}
                className="w-full text-sm p-2 border border-gray-300 rounded-lg dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
              />
              <button className="px-3 bg-white dark:bg-gray-800 border border-l-0 border-[#DC3545]  rounded-lg text-[#DC3545]">
                Remove
              </button>
            </div>
          ))}
