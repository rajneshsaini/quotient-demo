...
export default function Navbar() {
  return (
    <header className={"sticky top-0 right-0  bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 z-30 transition-all duration-300 w-full"} >
      ...
      <div className="h-[62px] flex items-center border-t border-t-[#0E253C1A]  text-base font-medium px-4 text-[#0E253CD9]">CRM / Account / <spam className='font-semibold text-[#0E253C]'>Account Details</spam></div>
    </header >
  );
}
